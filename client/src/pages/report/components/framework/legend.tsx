...
const Legend = ({ voteColors }) => {
  return (
    <svg style={{ width: 400, height: 20, border: "1px solid lightgrey" }}>
      ...
      <text y={14} x={8} fill="white" style={{ fontSize: 12 }}>
        % Agreed
      </text>
      <text y={14} x={115} fill="white" style={{ fontSize: 12 }}>
        % Disagreed
      </text>
      <text y={14} x={247} fill="black" style={{ fontSize: 12 }}>
        % Passed
      </text>
      <text y={14} x={318} fill="black" style={{ fontSize: 12 }}>
        % Didn&apos;t vote
      </text>
    </svg>
  )
