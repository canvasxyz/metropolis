...
export default connect((state: RootState) => state.mod_comments_accepted)(
  connect((state: RootState) => state.mod_comments_rejected)(
    connect((state: RootState) => state.mod_comments_unmoderated)(ConversationHasCommentsCheck)
  )
)
