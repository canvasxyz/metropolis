...
module.exports = Handlebones.ModelView.extend({
  ...
  initialize: function(options) {
    ...
    this.participantAgreed = function(e) {
      ...
      serverClient.agree(tid, starred, this.wipVote.highPriority)
    ...
    this.participantDisagreed = function() {
      ...
      serverClient.addToVotesByMe(this.wipVote);
      this.onButtonClicked();
      serverClient.disagree(tid, starred, this.wipVote.highPriority)
        .then(onVote.bind(this), onFail.bind(this));
    };
    this.participantPassed = function() {
      ...
      this.wipVote = {
        vote: 0,
        conversation_id: conversation_id,
        highPriority: this.highPriority(), // TODO: specify in help text that this is for "important but unsure"
        tid: tid
      };
      serverClient.addToVotesByMe(this.wipVote);
      this.onButtonClicked();
      serverClient.pass(tid, starred, this.wipVote.highPriority)
        .then(onVote.bind(this), onFail.bind(this));
    };
